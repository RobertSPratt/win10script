...
#
#     > powershell -nop -c "iex(New-Object Net.WebClient).DownloadString('https://git.io/JJxt1')"
#
...
#	
#	This is for my personal computers/Windows installations
#
...
#	- Does not install Adobe Reader
#	- Installs Vim
#	- Installs Firefox
#	- Installs FoxitReader
